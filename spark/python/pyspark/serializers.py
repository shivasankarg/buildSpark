...
class FramedSerializer(Serializer):
    ...
    def dump_stream(self, iterator, stream):
        transformationTotalTime = 0.0
        transformationStartTime = 0.0
        transformationEndTime = 0.0
        socketTotalTime = 0.0
        transformationStartTime = time.time()
        # temp = transformationStartTime
        for obj in iterator:
            transformationEndTime = time.time()
            transformationTotalTime += transformationEndTime - transformationStartTime
